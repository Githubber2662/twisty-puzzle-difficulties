...
const List = [["1×1×1 Cube, 1-layer Pyraminx, Dodecahedron etc. (already solved)", "Any 1×1×N cuboid (trivial solution)", "2-layer Pyraminx", "1×2×2 Cuboid", "Square-(-1) (identical to 1×2×3)", "1×2×3 Cuboid", "MoYu Unicorn Cube & Pyramid"], 
             ...
             ["3×3×4 Cuboid", "3×3×3 Cube", "5-Axis Pentahedra (J-Perm)", "Polaris Cube", "Master Skewb", "Mario 2×2×2", "Banana 2×2×3", "Ghost 1×3×3 Cuboid", "Square-1", "Megaminx", "2×2×2 Sudoku Cube", "Penrose Cube", "2×2×2 Mirror Cube"], ["4-layer Pyraminx", "Tuttminx", "4×4×4 Cube", "2×2×4 Cuboid", "Hexaminx", "Big Dipper Megaminx", "Square-2", "Curvy Copter (jumbled)", "5-layer Pyraminx", "2×2×2 Skewb", "5×5×5 Cube", "4 & 5-layer dodecahedra", "3×3×5 Cuboid", "3×3×3 Mirror Cube", "Pyramorphix"], 
             ["N-layer cubes, dodecahedra, pyraminxes, hexaminxes, mirror cubes etc.", "M×N×P Cuboids", "Square-N", "Gear Pyraminx"], ["3×3×3 Curvy Copter", "Mixup Cube", "4×4×4 Mixup Cube"]];
